...
export const signup = async (req, res) => {
    ...
    try {
        ...
        if (newUser) {
            ...
            res.status(201).json({ user: newUser, message: "New user created successfully" });
        } else {
...
export const updateProfile = async (req, res) => {
    try {
        ...
        const updatedUser = await User.findByIdAndUpdate(userId, { profilePic: uploadResponse.secure_url }, { new: true, runValidators: true, select: "-password" });
